...
It is assumed that you have read the [structs section](fruit/Coding/Testing/go/fundamentals/structs-methods-and-interfaces.md) before as some understanding of interfaces will be needed for this.
