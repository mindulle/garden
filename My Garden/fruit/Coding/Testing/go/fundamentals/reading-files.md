...
By relying on good software engineering practices like  [**dependency injection**](fruit/Coding/Testing/go/fundamentals/dependency-injection.md) our code is simple to test and re-use.
