...
[Long Method []{.fa .fa-arrow-right}](/smells/long-method){.btn
...
[[]{.fa .fa-arrow-left} Code Smells](/refactoring/smells){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/refactoring/smells/bloaters "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/refactoring/smells/bloaters "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/refactoring/smells/bloaters "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/refactoring/smells/bloaters "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/refactoring/smells/bloaters "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/refactoring/smells/bloaters "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/refactoring/smells/bloaters "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/refactoring/smells/bloaters "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/refactoring/smells/bloaters "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/refactoring/smells/bloaters "中文"){.dropdown-item
