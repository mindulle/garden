...
[Divergent Change []{.fa
.fa-arrow-right}](/smells/divergent-change){.btn .btn-primary
rel="next"}
:::
...
Interfaces](/smells/alternative-classes-with-different-interfaces){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/refactoring/smells/change-preventers "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/refactoring/smells/change-preventers "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/refactoring/smells/change-preventers "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/refactoring/smells/change-preventers "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/refactoring/smells/change-preventers "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/refactoring/smells/change-preventers "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/refactoring/smells/change-preventers "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/refactoring/smells/change-preventers "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/refactoring/smells/change-preventers "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/refactoring/smells/change-preventers "中文"){.dropdown-item
