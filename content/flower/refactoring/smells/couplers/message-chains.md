---
description: In code you see a series of calls resembling
  \$a-\>b()-\>c()-\>d()
lang: en
theme-color: "#95f3fc"
...
[Couplers](/refactoring/smells/couplers){.type}
:::
...
<figure class="image">
<img
src="/images/refactoring/content/smells/message-chains-01.png?id=c290ab1d348b3e6ab500c0b949f3d3f8"
srcset="/images/refactoring/content/smells/message-chains-01-2x.png?id=63332ad44f028e0d60f42d3a56e0280a 2x"
...
-   Sometimes it's better to think of why the end object is being used.
    Perhaps it would make sense to use [Extract Method](/extract-method)
    for this functionality and move it to the beginning of the chain, by
    using [Move Method](/move-method).

<figure class="image">
<img
src="/images/refactoring/content/smells/message-chains-02.png?id=d348325f450e592900b1a4a2ed960b53"
srcset="/images/refactoring/content/smells/message-chains-02-2x.png?id=07214cc9363ca16dcbaab4bb6e1edeef 2x"
...
<figure class="image">
<img
src="/images/refactoring/content/smells/message-chains-03.png?id=e651ac11f057e3e2e7c7786fc4051a66"
srcset="/images/refactoring/content/smells/message-chains-03-2x.png?id=2e0e5bdf1e249a09f9c8e67f01de6bd1 2x"
loading="lazy" width="500" height="300" />
</figure>
...
-   Overly aggressive delegate hiding can cause code in which it's hard
    ...
    another way of saying, avoid the [Middle Man](/smells/middle-man)
    smell as well.
...
[Middle Man []{.fa .fa-arrow-right}](/smells/middle-man){.btn
...
Intimacy](/smells/inappropriate-intimacy){.btn .btn-default rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/smells/message-chains "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/smells/message-chains "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/smells/message-chains "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/smells/message-chains "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/smells/message-chains "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/smells/message-chains "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/smells/message-chains "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/smells/message-chains "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/smells/message-chains "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/smells/message-chains "中文"){.dropdown-item
