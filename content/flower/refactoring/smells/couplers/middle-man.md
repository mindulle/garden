---
description: If a class performs only one action, delegating work to
...
<figure class="image">
<img
src="/images/refactoring/content/smells/middle-man-01.png?id=14c65845c4e0cf03e7e9e48108090c98"
srcset="/images/refactoring/content/smells/middle-man-01-2x.png?id=a1a99f8b475b719d9f894aa613515761 2x"
...
-   If most of a method's classes delegate to another class, [Remove
    Middle Man](/remove-middle-man) is in order.
...
<figure class="image">
<img
src="/images/refactoring/content/smells/middle-man-02.png?id=f507c0fd9a7bde8df8c22b9027d0a404"
srcset="/images/refactoring/content/smells/middle-man-02-2x.png?id=41869f090e8263d46e708778fe64059c 2x"
...
-   Some design patterns create middle man on purpose (such as
    [Proxy](/design-patterns/proxy) or
...
[Other Smells []{.fa .fa-arrow-right}](/refactoring/smells/other){.btn
...
[[]{.fa .fa-arrow-left} Message Chains](/smells/message-chains){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/smells/middle-man "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/smells/middle-man "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/smells/middle-man "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/smells/middle-man "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/smells/middle-man "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/smells/middle-man "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/smells/middle-man "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/smells/middle-man "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/smells/middle-man "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/smells/middle-man "中文"){.dropdown-item
