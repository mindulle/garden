---
description: If a subclass uses only some of the methods and properties
  inherited from its parents, the hierarchy is off-kilter. The unneeded
  methods may simply go unused or be redefined and give off exceptions.
lang: en
theme-color: "#95f3fc"
...
Smells](/refactoring/smells){.type} / [Object-Orientation
Abusers](/refactoring/smells/oo-abusers){.type}
:::
...
<figure class="image">
<img
src="/images/refactoring/content/smells/refused-bequest-01.png?id=7a1d79e75a3836c22ec865d72c98664e"
srcset="/images/refactoring/content/smells/refused-bequest-01-2x.png?id=d2e31b7b9fa3326118817b8e0c65e435 2x"
...
<figure class="image">
<img
src="/images/refactoring/content/smells/refused-bequest-02.png?id=f9b0affd4bbf6fec22c05783fc75562e"
srcset="/images/refactoring/content/smells/refused-bequest-02-2x.png?id=33b42b7d51bca13f27e4933d24f82751 2x"
...
<figure class="image">
<img
src="/images/refactoring/content/smells/refused-bequest-03.png?id=2a84293620fa1caf4329fca1f4a44e08"
srcset="/images/refactoring/content/smells/refused-bequest-03-2x.png?id=6990ba0083e3de07881bd551928e3a79 2x"
loading="lazy" width="500" height="300" />
</figure>
...
.fa-arrow-right}](/smells/alternative-classes-with-different-interfaces){.btn
...
[[]{.fa .fa-arrow-left} Temporary Field](/smells/temporary-field){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/smells/refused-bequest "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/smells/refused-bequest "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/smells/refused-bequest "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/smells/refused-bequest "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/smells/refused-bequest "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/smells/refused-bequest "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/smells/refused-bequest "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/smells/refused-bequest "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/smells/refused-bequest "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/smells/refused-bequest "中文"){.dropdown-item
