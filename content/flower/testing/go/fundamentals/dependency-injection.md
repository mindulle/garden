...
It is assumed that you have read the [structs section](flower/testing/go/fundamentals/structs-methods-and-interfaces.md) before as some understanding of interfaces will be needed for this.
