...
In [arrays & slices](flower/testing/go/fundamentals/arrays-and-slices.md), you saw how to store values in order. Now, we will look at a way to store items by a `key` and look them up quickly.
