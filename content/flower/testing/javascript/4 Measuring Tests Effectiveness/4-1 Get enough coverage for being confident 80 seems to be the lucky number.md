...
![alt text](flower/testing/javascript/assets/bp-18-yoni-goldberg-code-coverage.png "A typical coverage report")
...
![alt text](flower/testing/javascript/assets/bp-18-code-coverage2.jpeg "Setting up coverage per component (using Jest)")
