---
description: "Problem: You have a temporary variable that's assigned the
  result of a simple expression and nothing more. Solution: Replace the
  references to the variable with the expression itself."
lang: en
theme-color: "#95f3fc"
title: Inline Temp
...
with Query](/replace-temp-with-query) or to pave the way for [Extract
...
.fa-arrow-right}](/replace-temp-with-query){.btn .btn-primary
rel="next"}
...
[[]{.fa .fa-arrow-left} Extract Variable](/extract-variable){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/inline-temp "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/inline-temp "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/inline-temp "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/inline-temp "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/inline-temp "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/inline-temp "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/inline-temp "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/inline-temp "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/inline-temp "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/inline-temp "中文"){.dropdown-item
