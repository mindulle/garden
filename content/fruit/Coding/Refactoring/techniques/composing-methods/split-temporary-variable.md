---
description: "Problem: You have a local variable that's used to store
  various intermediate values inside a method (except for cycle
  variables). Solution: Use different variables for different values.
...
-   This refactoring technique is useful if you anticipate using
    [Extract Method](/extract-method) later.
...
.fa-arrow-right}](/remove-assignments-to-parameters){.btn .btn-primary
rel="next"}
...
Query](/replace-temp-with-query){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/split-temporary-variable "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/split-temporary-variable "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/split-temporary-variable "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/split-temporary-variable "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/split-temporary-variable "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/split-temporary-variable "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/split-temporary-variable "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/split-temporary-variable "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/split-temporary-variable "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/split-temporary-variable "中文"){.dropdown-item
