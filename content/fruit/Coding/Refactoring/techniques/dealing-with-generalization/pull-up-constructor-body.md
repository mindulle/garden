---
description: "Problem: Your subclasses have constructors with code
  that's mostly identical. Solution: Create a superclass constructor and
  move the code that's the same in the subclasses to it. Call the
...
[Push Down Method []{.fa .fa-arrow-right}](/push-down-method){.btn
...
[[]{.fa .fa-arrow-left} Pull Up Method](/pull-up-method){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/pull-up-constructor-body "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/pull-up-constructor-body "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/pull-up-constructor-body "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/pull-up-constructor-body "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/pull-up-constructor-body "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/pull-up-constructor-body "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/pull-up-constructor-body "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/pull-up-constructor-body "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/pull-up-constructor-body "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/pull-up-constructor-body "中文"){.dropdown-item
