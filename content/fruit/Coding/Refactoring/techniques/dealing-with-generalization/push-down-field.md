---
description: "Problem: Is a field used only in a few subclasses?
...
![Push Down Field -
Before](https://refactoring.guru/images/refactoring/diagrams/Push%20Down%20Field%20-%20Before.png?id=79ff2461236c616fcfbc5b0ab8abf5d9){width="452"}
...
![Push Down Field -
After](https://refactoring.guru/images/refactoring/diagrams/Push%20Down%20Field%20-%20After.png?id=b48b45a448c27122df61dab2c2451227){width="452"}
...
[Extract Subclass []{.fa .fa-arrow-right}](/extract-subclass){.btn
...
[[]{.fa .fa-arrow-left} Push Down Method](/push-down-method){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/push-down-field "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/push-down-field "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/push-down-field "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/push-down-field "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/push-down-field "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/push-down-field "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/push-down-field "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/push-down-field "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/push-down-field "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/push-down-field "中文"){.dropdown-item
