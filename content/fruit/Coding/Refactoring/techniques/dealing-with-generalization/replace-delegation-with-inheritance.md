---
description: "Problem: A class contains many simple methods that
  delegate to all methods of another class. Solution: Make the class a
  delegate inheritor, which makes the delegating methods unnecessary."
lang: en
theme-color: "#95f3fc"
...
[Techniques](/refactoring/techniques){.type} / [Dealing with
Generalization](/refactoring/techniques/dealing-with-generalization){.type}
...
Before](https://refactoring.guru/images/refactoring/diagrams/Replace%20Delegation%20with%20Inheritance%20-%20Before.png?id=b408bcc35ce5a341e675818d6c1124a2){width="453"}
...
![Replace Delegation with Inheritance -
After](https://refactoring.guru/images/refactoring/diagrams/Replace%20Delegation%20with%20Inheritance%20-%20After.png?id=633a1c3ff0e87033e10408df57ac6118){width="152"}
...
Delegation](/replace-inheritance-with-delegation){.btn .btn-default
rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-delegation-with-inheritance "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-delegation-with-inheritance "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-delegation-with-inheritance "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-delegation-with-inheritance "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-delegation-with-inheritance "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-delegation-with-inheritance "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-delegation-with-inheritance "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-delegation-with-inheritance "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-delegation-with-inheritance "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-delegation-with-inheritance "中文"){.dropdown-item
