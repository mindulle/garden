---
description: "Problem: You have a reference object that's too small and
  infrequently changed to justify managing its life cycle. Solution:
...
Before](https://refactoring.guru/images/refactoring/diagrams/Change%20Reference%20to%20Value%20-%20Before.png?id=584dcba345161853463376cef73ab205){width="377"}
...
![Change Reference to Value -
After](https://refactoring.guru/images/refactoring/diagrams/Change%20Reference%20to%20Value%20-%20After.png?id=08ac04b5ee1d4845fb6ebe409a4a6614){width="377"}
...
.fa-arrow-right}](/replace-array-with-object){.btn .btn-primary
rel="next"}
...
Reference](/change-value-to-reference){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/change-reference-to-value "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/change-reference-to-value "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/change-reference-to-value "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/change-reference-to-value "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/change-reference-to-value "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/change-reference-to-value "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/change-reference-to-value "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/change-reference-to-value "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/change-reference-to-value "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/change-reference-to-value "中文"){.dropdown-item
