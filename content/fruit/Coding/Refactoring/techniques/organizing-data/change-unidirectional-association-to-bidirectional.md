---
description: "Problem: You have two classes that each need to use the
  features of the other, but the association between them is only
  unidirectional. Solution: Add the missing association to the class
  that needs it."
lang: en
theme-color: "#95f3fc"
...
Before](https://refactoring.guru/images/refactoring/diagrams/Change%20Unidirectional%20Association%20to%20Bidirectional%20-%20Before.png?id=a31d8472bbb2be95836c8b5e2334ac77){width="396"}
...
![Change Unidirectional Association to Bidirectional -
After](https://refactoring.guru/images/refactoring/diagrams/Change%20Unidirectional%20Association%20to%20Bidirectional%20-%20After.png?id=058ba44a44610bcb9caa4c23f60ad0bc){width="396"}
...
.fa-arrow-right}](/change-bidirectional-association-to-unidirectional){.btn
...
Data](/duplicate-observed-data){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/change-unidirectional-association-to-bidirectional "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/change-unidirectional-association-to-bidirectional "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/change-unidirectional-association-to-bidirectional "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/change-unidirectional-association-to-bidirectional "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/change-unidirectional-association-to-bidirectional "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/change-unidirectional-association-to-bidirectional "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/change-unidirectional-association-to-bidirectional "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/change-unidirectional-association-to-bidirectional "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/change-unidirectional-association-to-bidirectional "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/change-unidirectional-association-to-bidirectional "中文"){.dropdown-item
