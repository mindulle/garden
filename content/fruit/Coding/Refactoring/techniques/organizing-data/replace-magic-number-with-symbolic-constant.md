---
description: "Problem: Your code uses a number that has a certain
  meaning to it. Solution: Replace this number with a constant that has
  a human-readable name explaining the meaning of the number."
lang: en
theme-color: "#95f3fc"
...
[Encapsulate Field []{.fa .fa-arrow-right}](/encapsulate-field){.btn
...
Unidirectional](/change-bidirectional-association-to-unidirectional){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-magic-number-with-symbolic-constant "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-magic-number-with-symbolic-constant "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-magic-number-with-symbolic-constant "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-magic-number-with-symbolic-constant "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-magic-number-with-symbolic-constant "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-magic-number-with-symbolic-constant "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-magic-number-with-symbolic-constant "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-magic-number-with-symbolic-constant "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-magic-number-with-symbolic-constant "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-magic-number-with-symbolic-constant "中文"){.dropdown-item
