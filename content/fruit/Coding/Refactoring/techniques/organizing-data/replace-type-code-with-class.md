---
description: "Problem: A class has a field that contains type code. The
  values of this type aren't used in operator conditions and don't
  affect the behavior of the program. Solution: Create a new class and
  use its objects instead of the type code values."
lang: en
theme-color: "#95f3fc"
...
Before](https://refactoring.guru/images/refactoring/diagrams/Replace%20Type%20Code%20with%20Class%20-%20Before.png?id=1b492169f36a1b9da5bb6d9e6f857f45){width="152"}
...
![Replace Type Code with Class -
After](https://refactoring.guru/images/refactoring/diagrams/Replace%20Type%20Code%20with%20Class%20-%20After.png?id=c3be25afb117027a6d56cc489d0e7ae6){width="152"}
...
.fa-arrow-right}](/replace-type-code-with-subclasses){.btn .btn-primary
rel="next"}
...
Collection](/encapsulate-collection){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-type-code-with-class "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-type-code-with-class "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-type-code-with-class "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-type-code-with-class "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-type-code-with-class "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-type-code-with-class "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-type-code-with-class "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-type-code-with-class "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-type-code-with-class "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-type-code-with-class "中文"){.dropdown-item
