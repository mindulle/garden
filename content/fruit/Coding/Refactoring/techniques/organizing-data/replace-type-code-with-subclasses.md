---
description: "Problem: You have a coded type that directly affects
  program behavior (values of this field trigger various code in
  conditionals). Solution: Create subclasses for each value of the coded
...
[![](https://refactoring.guru/images/content-public/ann/autumn/read.svg?id=0d119719d4d53f2e62fc6535cb544b74){loading="lazy"
style="width: 32px; height:32px;vertical-align: middle;"}
![](https://refactoring.guru/images/content-public/ann/autumn/tea-cup.svg?id=f95aba0fef52083e2dd0a8a64068e37f){loading="lazy"
style="width: 32px; height:32px;vertical-align: middle;"} [Autumn
SALE]{.announcement-link-text}
![](https://refactoring.guru/images/content-public/ann/autumn/mulled-wine.svg?id=ad4bec48a83ede3e72766d40a6a837ed){loading="lazy"
style="width: 32px; height:32px;vertical-align: middle;"}
![](https://refactoring.guru/images/content-public/ann/autumn/maple-leaf.svg?id=63cdc79ea962a2657a57f44a22d092b9){loading="lazy"
...
Before](https://refactoring.guru/images/refactoring/diagrams/Replace%20Type%20Code%20with%20Subclasses%20-%20Before.png?id=5fa75a3c084933dcb4d1d1f0c60e56d3){width="152"}
...
![Replace Type Code with Subclasses -
After](https://refactoring.guru/images/refactoring/diagrams/Replace%20Type%20Code%20with%20Subclasses%20-%20After.png?id=9a9b00b277bd590e01589a441f50410e){width="302"}
...
Code with Class](/replace-type-code-with-class).
...
Class](/replace-type-code-with-class) here, all these control flow
...
-   This technique isn't applicable if you already have a class
    ...
    with State/Strategy](/replace-type-code-with-state-strategy).
...
1.  Use [Self Encapsulate Field](/self-encapsulate-field) to create a
    getter for the field that contains type code.
...
5.  Now that you have subclasses, you can start to move the fields and
    ...
    help of [Push Down Field](/push-down-field) and [Push Down
    Method](/push-down-method)).

6.  When everything possible has been moved, use [Replace Conditional
    with Polymorphism](/replace-conditional-with-polymorphism) in order
...
.fa-arrow-right}](/replace-type-code-with-state-strategy){.btn
...
Class](/replace-type-code-with-class){.btn .btn-default rel="prev"}
...
[![](https://refactoring.guru/images/refactoring/course/course-cover-en.jpg?id=ac6ad836a27c4a8d579244f15c48a8b4){width="300"
...
[![Refactoring.Guru](https://refactoring.guru/images/content-public/logos/logo-new.png?id=97d554614702483f31e38b32e82d8e34){width="200"
height="241" loading="lazy"
srcset="https://refactoring.guru/images/content-public/logos/logo-new-2x.png?id=3bc33294e095bab1d6fe9ae421d07837 2x"}](/){.menu-brand}
...
[![Refactoring.Guru](https://refactoring.guru/images/content-public/logos/logo-new-mobile.png?id=ea18aa9b032eaa92835ed6d472b03b4a){srcset="https://refactoring.guru/images/content-public/logos/logo-new-mobile-2x.png?id=7ad5648bfd86ae2e8524147a72877c64 2x"}](/){.navigation-brand}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-type-code-with-subclasses "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-type-code-with-subclasses "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-type-code-with-subclasses "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-type-code-with-subclasses "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-type-code-with-subclasses "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-type-code-with-subclasses "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-type-code-with-subclasses "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-type-code-with-subclasses "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-type-code-with-subclasses "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-type-code-with-subclasses "中文"){.dropdown-item
