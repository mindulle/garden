...
.fa-arrow-right}](/decompose-conditional){.btn .btn-primary rel="next"}
...
Fields](/replace-subclass-with-fields){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/refactoring/techniques/simplifying-conditional-expressions "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/refactoring/techniques/simplifying-conditional-expressions "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/refactoring/techniques/simplifying-conditional-expressions "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/refactoring/techniques/simplifying-conditional-expressions "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/refactoring/techniques/simplifying-conditional-expressions "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/refactoring/techniques/simplifying-conditional-expressions "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/refactoring/techniques/simplifying-conditional-expressions "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/refactoring/techniques/simplifying-conditional-expressions "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/refactoring/techniques/simplifying-conditional-expressions "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/refactoring/techniques/simplifying-conditional-expressions "中文"){.dropdown-item
