---
description: "Problem: You have multiple conditionals that lead to the
  same result or action. Solution: Consolidate all these conditionals in
  a single expression."
lang: en
theme-color: "#95f3fc"
...
2.  Perform [Extract Method](/extract-method) on the operator conditions
...
.fa-arrow-right}](/consolidate-duplicate-conditional-fragments){.btn
...
Conditional](/decompose-conditional){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/consolidate-conditional-expression "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/consolidate-conditional-expression "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/consolidate-conditional-expression "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/consolidate-conditional-expression "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/consolidate-conditional-expression "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/consolidate-conditional-expression "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/consolidate-conditional-expression "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/consolidate-conditional-expression "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/consolidate-conditional-expression "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/consolidate-conditional-expression "中文"){.dropdown-item
