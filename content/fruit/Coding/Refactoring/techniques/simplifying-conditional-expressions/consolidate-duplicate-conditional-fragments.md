---
description: "Problem: Identical code can be found in all branches of a
  conditional. Solution: Move the code outside of the conditional."
lang: en
theme-color: "#95f3fc"
...
4.  If appropriate and the duplicate code is longer than one line, try
    using [Extract Method](/extract-method).
...
[Remove Control Flag []{.fa .fa-arrow-right}](/remove-control-flag){.btn
...
Expression](/consolidate-conditional-expression){.btn .btn-default
rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/consolidate-duplicate-conditional-fragments "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/consolidate-duplicate-conditional-fragments "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/consolidate-duplicate-conditional-fragments "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/consolidate-duplicate-conditional-fragments "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/consolidate-duplicate-conditional-fragments "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/consolidate-duplicate-conditional-fragments "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/consolidate-duplicate-conditional-fragments "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/consolidate-duplicate-conditional-fragments "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/consolidate-duplicate-conditional-fragments "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/consolidate-duplicate-conditional-fragments "中文"){.dropdown-item
