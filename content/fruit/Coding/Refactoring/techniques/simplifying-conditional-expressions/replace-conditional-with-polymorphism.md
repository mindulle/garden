---
description: "Problem: You have a conditional that performs various
  actions depending on object type or properties. Solution: Create
  subclasses matching the branches of the conditional. In them, create a
  shared method and move code from the corresponding branch of the
  conditional to it. Then replace the conditional with the relevant
...
-   [Replace Type Code with
    Subclasses](/replace-type-code-with-subclasses). Subclasses will be
...
-   [Replace Type Code with
    State/Strategy](/replace-type-code-with-state-strategy). A class
...
1.  If the conditional is in a method that performs other actions as
    well, perform [Extract Method](/extract-method).
...
.fa-arrow-right}](/introduce-null-object){.btn .btn-primary rel="next"}
...
Clauses](/replace-nested-conditional-with-guard-clauses){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-conditional-with-polymorphism "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-conditional-with-polymorphism "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-conditional-with-polymorphism "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-conditional-with-polymorphism "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-conditional-with-polymorphism "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-conditional-with-polymorphism "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-conditional-with-polymorphism "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-conditional-with-polymorphism "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-conditional-with-polymorphism "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-conditional-with-polymorphism "中文"){.dropdown-item
