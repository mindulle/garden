---
description: "Problem: A method doesn't have enough data to perform
  certain actions. Solution: Create a new parameter to pass the
  necessary data."
lang: en
theme-color: "#95f3fc"
title: Add Parameter
...
![Add Parameter -
Before](https://refactoring.guru/images/refactoring/diagrams/Add%20Parameter%20-%20Before.png?id=a060d5ffb8661cee995f02ead0d8547b){width="171"}
...
![Add Parameter -
After](https://refactoring.guru/images/refactoring/diagrams/Add%20Parameter%20-%20After.png?id=c49cf53fd9ebf39daa1ec27bb897a5cf){width="171"}
...
-   Adding a new parameter is always easier than removing it, which is
    ...
    List](/smells/long-parameter-list).
...
[Remove Parameter []{.fa .fa-arrow-right}](/remove-parameter){.btn
...
[[]{.fa .fa-arrow-left} Rename Method](/rename-method){.btn .btn-default
rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/add-parameter "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/add-parameter "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/add-parameter "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/add-parameter "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/add-parameter "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/add-parameter "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/add-parameter "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/add-parameter "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/add-parameter "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/add-parameter "中文"){.dropdown-item
