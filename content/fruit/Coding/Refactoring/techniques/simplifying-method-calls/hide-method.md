---
description: "Problem: A method isn't used by other classes or is used
  only inside its own class hierarchy. Solution: Make the method private
  or protected."
lang: en
theme-color: "#95f3fc"
title: Hide Method
...
![Hide Method -
Before](https://refactoring.guru/images/refactoring/diagrams/Hide%20Method%20-%20Before.png?id=598219cd5a4b26974b091534b2dc89ae){width="134"}
...
![Hide Method -
After](https://refactoring.guru/images/refactoring/diagrams/Hide%20Method%20-%20After.png?id=2f7f1435a959a0a611778513e5bc4365){width="134"}
...
.fa-arrow-right}](/replace-constructor-with-factory-method){.btn
...
Method](/remove-setting-method){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/hide-method "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/hide-method "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/hide-method "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/hide-method "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/hide-method "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/hide-method "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/hide-method "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/hide-method "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/hide-method "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/hide-method "中文"){.dropdown-item
