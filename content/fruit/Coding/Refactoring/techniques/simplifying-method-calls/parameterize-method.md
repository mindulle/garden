---
description: "Problem: Multiple methods perform similar actions that are
...
![Parameterize Method -
Before](https://refactoring.guru/images/refactoring/diagrams/Parameterize%20Method%20-%20Before.png?id=28369c5a763d56c4aa68ff0a9d2d6beb){width="171"}
...
![Parameterize Method -
After](https://refactoring.guru/images/refactoring/diagrams/Parameterize%20Method%20-%20After.png?id=fd1602ffde98a8fea3ad50cb63e14553){width="171"}
...
1.  Create a new method with a parameter and move it to the code that's
    ...
    Method](/extract-method). Note that sometimes only a certain part of
    methods is actually the same. In this case, refactoring consists of
    extracting only the same part to a new method.
...
.fa-arrow-right}](/replace-parameter-with-explicit-methods){.btn
...
Modifier](/separate-query-from-modifier){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/parameterize-method "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/parameterize-method "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/parameterize-method "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/parameterize-method "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/parameterize-method "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/parameterize-method "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/parameterize-method "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/parameterize-method "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/parameterize-method "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/parameterize-method "中文"){.dropdown-item
