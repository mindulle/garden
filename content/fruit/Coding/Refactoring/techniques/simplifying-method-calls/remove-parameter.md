---
description: "Problem: A parameter isn't used in the body of a method.
...
![Remove Parameter -
Before](https://refactoring.guru/images/refactoring/diagrams/Remove%20Parameter%20-%20Before.png?id=c49cf53fd9ebf39daa1ec27bb897a5cf){width="171"}
...
![Remove Parameter -
After](https://refactoring.guru/images/refactoring/diagrams/Remove%20Parameter%20-%20After.png?id=93177c2a159087d73ebef60cc8c158a3){width="171"}
...
.fa-arrow-right}](/separate-query-from-modifier){.btn .btn-primary
rel="next"}
...
[[]{.fa .fa-arrow-left} Add Parameter](/add-parameter){.btn .btn-default
rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/remove-parameter "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/remove-parameter "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/remove-parameter "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/remove-parameter "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/remove-parameter "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/remove-parameter "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/remove-parameter "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/remove-parameter "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/remove-parameter "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/remove-parameter "中文"){.dropdown-item
