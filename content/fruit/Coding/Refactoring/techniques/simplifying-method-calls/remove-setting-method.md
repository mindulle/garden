---
description: "Problem: The value of a field should be set only when it's
  created, and not change at any time after that. Solution: So remove
  methods that set the field's value."
lang: en
theme-color: "#95f3fc"
...
Before](https://refactoring.guru/images/refactoring/diagrams/Remove%20Setting%20Method%20-%20Before.png?id=6f5c0d77289a8f59a2bb89032d5bc55f){width="190"}
...
![Remove Setting Method -
After](https://refactoring.guru/images/refactoring/diagrams/Remove%20Setting%20Method%20-%20After.png?id=5e75fe3df982c4da469ddceb96530058){width="190"}
...
[Hide Method []{.fa .fa-arrow-right}](/hide-method){.btn .btn-primary
rel="next"}
...
Object](/introduce-parameter-object){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/remove-setting-method "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/remove-setting-method "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/remove-setting-method "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/remove-setting-method "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/remove-setting-method "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/remove-setting-method "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/remove-setting-method "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/remove-setting-method "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/remove-setting-method "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/remove-setting-method "中文"){.dropdown-item
