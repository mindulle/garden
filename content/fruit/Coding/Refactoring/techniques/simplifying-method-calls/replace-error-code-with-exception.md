---
description: "Problem: A method returns a special value that indicates
  an error? Solution: Throw an exception instead."
lang: en
theme-color: "#95f3fc"
...
.fa-arrow-right}](/replace-exception-with-test){.btn .btn-primary
rel="next"}
...
Method](/replace-constructor-with-factory-method){.btn .btn-default
rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-error-code-with-exception "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-error-code-with-exception "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-error-code-with-exception "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-error-code-with-exception "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-error-code-with-exception "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-error-code-with-exception "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-error-code-with-exception "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-error-code-with-exception "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-error-code-with-exception "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-error-code-with-exception "中文"){.dropdown-item
