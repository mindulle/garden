---
description: "Problem: A method is split into parts, each of which is
  run depending on the value of a parameter. Solution: Extract the
  individual parts of the method into their own methods and call them
...
.fa-arrow-right}](/preserve-whole-object){.btn .btn-primary rel="next"}



#### Return

[[]{.fa .fa-arrow-left} Parameterize Method](/parameterize-method){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-parameter-with-explicit-methods "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-parameter-with-explicit-methods "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-parameter-with-explicit-methods "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-parameter-with-explicit-methods "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-parameter-with-explicit-methods "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-parameter-with-explicit-methods "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-parameter-with-explicit-methods "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-parameter-with-explicit-methods "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-parameter-with-explicit-methods "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-parameter-with-explicit-methods "中文"){.dropdown-item
