---
description: "Problem: Calling a query method and passing its results as
  the parameters of another method, while that method could call the
  query directly. Solution: Instead of passing the value through a
  parameter, try placing a query call inside the method body."
lang: en
theme-color: "#95f3fc"
...
2.  If the relevant code is more complicated than a single method or
    function call, use [Extract Method](/extract-method) to isolate this
...
4.  Use [Remove Parameter](/remove-parameter) to eliminate the
...
.fa-arrow-right}](/introduce-parameter-object){.btn .btn-primary
rel="next"}
...
Object](/preserve-whole-object){.btn .btn-default rel="prev"}
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-parameter-with-method-call "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-parameter-with-method-call "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-parameter-with-method-call "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-parameter-with-method-call "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-parameter-with-method-call "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-parameter-with-method-call "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-parameter-with-method-call "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-parameter-with-method-call "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-parameter-with-method-call "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-parameter-with-method-call "中文"){.dropdown-item
