...
Go offers you a way to be more abstract with your types with [interfaces](fruit/Coding/Testing/go/fundamentals/structs-methods-and-interfaces.md), so that you can design functions that do not take concrete types but instead, types that offer the behaviour you need. This gives you some flexibility whilst maintaining type-safety.
