...
[In the previous chapter](fruit/Testing/go/build_an_application/json.md) we continued iterating on our application by adding a new endpoint `/league`. Along the way we learned about how to deal with JSON, embedding types and routing.
