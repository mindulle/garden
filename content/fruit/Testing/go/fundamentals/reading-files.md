...
By relying on good software engineering practices like  [**dependency injection**](fruit/Testing/go/fundamentals/dependency-injection.md) our code is simple to test and re-use.
