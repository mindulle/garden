---
description: Whenever you create a subclass for a class, you find
...
<figure class="image">
<img
src="/images/refactoring/content/smells/parallel-inheritance-hierarchies-01.png?id=9167875f5f0e80256edcc8fcaaed3563"
srcset="/images/refactoring/content/smells/parallel-inheritance-hierarchies-01-2x.png?id=975e6a0589795c59b47ed3aa122beead 2x"
...
-   You may de-duplicate parallel class hierarchies in two steps. First,
    ...
    using [Move Method](/move-method) and [Move Field](/move-field).
...
<figure class="image">
<img
src="/images/refactoring/content/smells/parallel-inheritance-hierarchies-02.png?id=4dca6795d3d087b23ad1027298d6f1dd"
srcset="/images/refactoring/content/smells/parallel-inheritance-hierarchies-02-2x.png?id=b45e8dde4f4abbe2f0d329964c921960 2x"
...
[Dispensables []{.fa
.fa-arrow-right}](/refactoring/smells/dispensables){.btn .btn-primary
rel="next"}
:::
...
[[]{.fa .fa-arrow-left} Shotgun Surgery](/smells/shotgun-surgery){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/smells/parallel-inheritance-hierarchies "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/smells/parallel-inheritance-hierarchies "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/smells/parallel-inheritance-hierarchies "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/smells/parallel-inheritance-hierarchies "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/smells/parallel-inheritance-hierarchies "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/smells/parallel-inheritance-hierarchies "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/smells/parallel-inheritance-hierarchies "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/smells/parallel-inheritance-hierarchies "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/smells/parallel-inheritance-hierarchies "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/smells/parallel-inheritance-hierarchies "中文"){.dropdown-item
