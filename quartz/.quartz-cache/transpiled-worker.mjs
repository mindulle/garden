...
function ExplorerNode({ node, opts, fullPath, fileData }) {
  ...
  return /* @__PURE__ */ jsx20("li", { children: node.file ? (
    // Single file node
    ...
    /* @__PURE__ */ jsxs10("div", { class: "folder-container", children: [
      ...
      /* @__PURE__ */ jsx20("div", { "data-folderpath": folderPath, children: folderBehavior === "link" ? /* @__PURE__ */ jsx20("a", { href: `${folderPath}`, "data-for": node.name, class: "folder-title", children: node.displayName }) : /* @__PURE__ */ jsx20("button", { class: "folder-button", children: /* @__PURE__ */ jsx20("p", { class: "folder-title", children: node.displayName }) }) }, node.name)
    ] }),
...
import { Fragment as Fragment3, jsx as jsx27 } from "preact/jsx-runtime";
...
import { Fragment as Fragment4, jsx as jsx28 } from "preact/jsx-runtime";
...
import { Fragment as Fragment5, jsx as jsx30, jsxs as jsxs17 } from "preact/jsx-runtime";
...
var Breadcrumbs_default = /* @__PURE__ */ __name((opts) => {
  ...
  function Breadcrumbs({ fileData, allFiles, displayClass }) {
    if (options2.hideOnRoot && fileData.slug === "index") {
      return /* @__PURE__ */ jsx30(Fragment5, {});
    }
...
var sharedPageComponents = {
  ...
  footer: Footer_default({
    links: {
      GitHub: "https://github.com/mindulle"
    }
  })
};
  ...
  async emit({ argv }, content, _resources, emit) {
    ...
    for (const [_tree, file] of content) {
      ...
      for (let slug2 of slugs) {
        if (slug2.endsWith("/")) {
          slug2 = joinSegments(slug2, "index");
        }
