---
description: Making any modifications requires that you make many small
...
Smells](/refactoring/smells){.type} / [Change
Preventers](/refactoring/smells/change-preventers){.type}
:::

# Shotgun Surgery {#shotgun-surgery .title}

> *Shotgun Surgery* resembles [Divergent
> Change](/smells/divergent-change) but is actually the opposite smell.
...
<figure class="image">
<img
src="/images/refactoring/content/smells/shotgun-surgery-01.png?id=9cc1117a6d787364788e152a3adb6a53"
srcset="/images/refactoring/content/smells/shotgun-surgery-01-2x.png?id=01431b43fcaee83fade53530a3dd91ab 2x"
...
Change](/smells/divergent-change).

<figure class="image">
<img
src="/images/refactoring/content/smells/shotgun-surgery-02.png?id=48f8a4a0f17d112e02ae73bacaed43fa"
srcset="/images/refactoring/content/smells/shotgun-surgery-02-2x.png?id=a35426ca3f6e64857e66b2fdeb395870 2x"
loading="lazy" width="500" height="300" />
</figure>

### Treatment

-   Use [Move Method](/move-method) and [Move Field](/move-field) to
    move existing class behaviors into a single class. If there's no
    class appropriate for this, create a new one.
...
<figure class="image">
<img
src="/images/refactoring/content/smells/shotgun-surgery-03.png?id=cf013f14eb5cde98bd48595a1c9836a9"
srcset="/images/refactoring/content/smells/shotgun-surgery-03-2x.png?id=259b00413f0f8be143ead703c74b7e38 2x"
loading="lazy" width="500" height="300" />
</figure>
...
.fa-arrow-right}](/smells/parallel-inheritance-hierarchies){.btn
...
[[]{.fa .fa-arrow-left} Divergent Change](/smells/divergent-change){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/smells/shotgun-surgery "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/smells/shotgun-surgery "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/smells/shotgun-surgery "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/smells/shotgun-surgery "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/smells/shotgun-surgery "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/smells/shotgun-surgery "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/smells/shotgun-surgery "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/smells/shotgun-surgery "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/smells/shotgun-surgery "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/smells/shotgun-surgery "中文"){.dropdown-item
