...
.fa-arrow-right}](/refactoring/techniques/moving-features-between-objects){.btn
...
Object](/replace-method-with-method-object){.btn .btn-default
rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/substitute-algorithm "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/substitute-algorithm "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/substitute-algorithm "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/substitute-algorithm "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/substitute-algorithm "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/substitute-algorithm "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/substitute-algorithm "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/substitute-algorithm "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/substitute-algorithm "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/substitute-algorithm "中文"){.dropdown-item
