---
description: "Problem: You have a class hierarchy in which a subclass is
  practically the same as its superclass. Solution: Merge the subclass
  and superclass."
lang: en
theme-color: "#95f3fc"
...
::: ba-container
![Collapse Hierarchy -
Before](/images/refactoring/diagrams/Collapse%20Hierarchy%20-%20Before.png?id=e95d97b3a9d564fbdba5ec0b76748f88){width="152"}
:::
:::
...
::: ba-container
![Collapse Hierarchy -
After](/images/refactoring/diagrams/Collapse%20Hierarchy%20-%20After.png?id=db86997e7b68eaac829168048cd02a8b){width="152"}
:::
:::
:::
:::
...
::: dd
*Collapse Hierarchy* is a variation of [Inline Class](/inline-class),
where the code moves to superclass or subclass.
:::
:::
:::
...
.fa-arrow-right}](/form-template-method){.btn .btn-primary rel="next"}
:::

::: prev
#### Return

[[]{.fa .fa-arrow-left} Extract Interface](/extract-interface){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/collapse-hierarchy "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/collapse-hierarchy "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/collapse-hierarchy "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/collapse-hierarchy "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/collapse-hierarchy "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/collapse-hierarchy "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/collapse-hierarchy "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/collapse-hierarchy "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/collapse-hierarchy "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/collapse-hierarchy "中文"){.dropdown-item
