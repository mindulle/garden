---
description: "Problem: Multiple clients are using the same part of a
  class interface. Another case: part of the interface in two classes is
  the same. Solution: Move this identical portion to its own interface."
lang: en
theme-color: "#95f3fc"
...
::: ba-container
![Extract Interface -
Before](/images/refactoring/diagrams/Extract%20Interface%20-%20Before.png?id=fc2bba34908c16e2b86c5c9cc8c424b1){width="209"}
:::
:::
...
::: ba-container
![Extract Interface -
After](/images/refactoring/diagrams/Extract%20Interface%20-%20After.png?id=2692cc5b979184941c55080bc89226b4){width="209"}
:::
:::
:::
:::
...
1.  Interfaces are very apropos when classes play special roles in
    different situations. Use [Extract Interface](/extract-interface) to
    explicitly indicate which role.
...
Code](/smells/duplicate-code), extracting the interface won't help you
to deduplicate.

All the same, this problem can be mitigated by applying [Extract
Class](/extract-class) to move the behavior that contains the
...
Superclass](/extract-superclass). This is even easier, of course, but
...
[Collapse Hierarchy []{.fa .fa-arrow-right}](/collapse-hierarchy){.btn
...
[[]{.fa .fa-arrow-left} Extract Superclass](/extract-superclass){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/extract-interface "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/extract-interface "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/extract-interface "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/extract-interface "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/extract-interface "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/extract-interface "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/extract-interface "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/extract-interface "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/extract-interface "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/extract-interface "中文"){.dropdown-item
