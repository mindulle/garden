---
description: "Problem: Your subclasses implement algorithms that contain
  similar steps in the same order. Solution: Move the algorithm
  structure and identical steps to a superclass, and leave
...
Before](/images/refactoring/diagrams/Form%20Template%20Method%20-%20Before.png?id=858de51c181ba956e5ecf63e3a88fda2){width="696"}
:::
:::
...
::: ba-container
![Form Template Method -
After](/images/refactoring/diagrams/Form%20Template%20Method%20-%20After.png?id=7a2977c70d9fcd80c96307a877343828){width="640"}
:::
:::
:::
:::
...
.fa-arrow-right}](/replace-inheritance-with-delegation){.btn
...
[[]{.fa .fa-arrow-left} Collapse Hierarchy](/collapse-hierarchy){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/form-template-method "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/form-template-method "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/form-template-method "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/form-template-method "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/form-template-method "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/form-template-method "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/form-template-method "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/form-template-method "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/form-template-method "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/form-template-method "中文"){.dropdown-item
