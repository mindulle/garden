---
description: "Problem: Two classes have the same field. Solution: Remove
  the field from subclasses and move it to the superclass."
lang: en
theme-color: "#95f3fc"
title: Pull Up Field
...
::: ba-container
![Pull Up Field -
Before](/images/refactoring/diagrams/Pull%20Up%20Field%20-%20Before.png?id=8174b96aa69ce1541271a14b97cc3e33){width="452"}
:::
:::
...
::: ba-container
![Pull Up Field -
After](/images/refactoring/diagrams/Pull%20Up%20Field%20-%20After.png?id=c97f930072aba9f00c03ba140797de19){width="452"}
:::
:::
:::
:::
...
[Pull Up Method []{.fa .fa-arrow-right}](/pull-up-method){.btn
...
Generalization](/refactoring/techniques/dealing-with-generalization){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/pull-up-field "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/pull-up-field "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/pull-up-field "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/pull-up-field "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/pull-up-field "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/pull-up-field "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/pull-up-field "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/pull-up-field "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/pull-up-field "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/pull-up-field "中文"){.dropdown-item
