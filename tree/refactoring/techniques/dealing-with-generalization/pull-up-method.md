---
description: "Problem: Your subclasses have methods that perform similar
  work. Solution: Make the methods identical and then move them to the
  relevant superclass."
lang: en
theme-color: "#95f3fc"
...
::: ba-container
![Pull Up Method -
Before](/images/refactoring/diagrams/Pull%20Up%20Method%20-%20Before.png?id=1af4e8b520779e6b72d6d91115f6373f){width="452"}
:::
:::
...
::: ba-container
![Pull Up Method -
After](/images/refactoring/diagrams/Pull%20Up%20Method%20-%20After.png?id=57193e5593115571e969abe471dfd9aa){width="452"}
:::
:::
:::
:::
...
.fa-arrow-right}](/pull-up-constructor-body){.btn .btn-primary
rel="next"}
:::
...
[[]{.fa .fa-arrow-left} Pull Up Field](/pull-up-field){.btn .btn-default
rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/pull-up-method "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/pull-up-method "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/pull-up-method "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/pull-up-method "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/pull-up-method "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/pull-up-method "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/pull-up-method "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/pull-up-method "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/pull-up-method "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/pull-up-method "中文"){.dropdown-item
