---
description: "Problem: You have a subclass that uses only a portion of
  the methods of its superclass (or it's not possible to inherit
  superclass data). Solution: Create a field and put a superclass object
  in it, delegate methods to the superclass object, and get rid of
  inheritance."
lang: en
theme-color: "#95f3fc"
...
Before](/images/refactoring/diagrams/Replace%20Inheritance%20with%20Delegation%20-%20Before.png?id=ea9631c50eaae9a19a51f039b44e35bf){width="152"}
:::
:::
...
::: ba-container
![Replace Inheritance with Delegation -
After](/images/refactoring/diagrams/Replace%20Inheritance%20with%20Delegation%20-%20After.png?id=7c6d23661792658feae42d051b2fd7ea){width="453"}
:::
:::
:::
:::
...
-   Various objects with various implementations can be put in the
    ...
    [Strategy](/design-patterns/strategy) design pattern.
...
.fa-arrow-right}](/replace-delegation-with-inheritance){.btn
...
Method](/form-template-method){.btn .btn-default rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-inheritance-with-delegation "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-inheritance-with-delegation "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-inheritance-with-delegation "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-inheritance-with-delegation "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-inheritance-with-delegation "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-inheritance-with-delegation "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-inheritance-with-delegation "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-inheritance-with-delegation "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-inheritance-with-delegation "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-inheritance-with-delegation "中文"){.dropdown-item
