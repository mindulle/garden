---
description: "Problem: When one class does the work of two, awkwardness
  results. Solution: Instead, create a new class and place the fields
  and methods responsible for the relevant functionality in it."
lang: en
theme-color: "#95f3fc"
title: Extract Class
...
::: ba-container
![Extract Class -
Before](/images/refactoring/diagrams/Extract%20Class%20-%20Before.png?id=7cb7db0fe2ab0d17f067d411f9e98f15){width="209"}
:::
:::
...
::: ba-container
![Extract Class -
After](/images/refactoring/diagrams/Extract%20Class%20-%20After.png?id=717d80baaa902d09acbaa55fd0539638){width="509"}
:::
:::
:::
:::
...
[Inline Class []{.fa .fa-arrow-right}](/inline-class){.btn .btn-primary
rel="next"}
:::
...
[[]{.fa .fa-arrow-left} Move Field](/move-field){.btn .btn-default
rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/extract-class "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/extract-class "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/extract-class "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/extract-class "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/extract-class "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/extract-class "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/extract-class "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/extract-class "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/extract-class "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/extract-class "中文"){.dropdown-item
