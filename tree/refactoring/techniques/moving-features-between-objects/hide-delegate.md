---
description: "Problem: The client gets object B from a field or method
  of object А. Then the client calls a method of object B. Solution:
...
::: ba-container
![Hide Delegate -
Before](/images/refactoring/diagrams/Hide%20Delegate%20-%20Before.png?id=f7de1016e76545f7c51af09463ce5f4c){width="415"}
:::
:::
...
::: ba-container
![Hide Delegate -
After](/images/refactoring/diagrams/Hide%20Delegate%20-%20After.png?id=f51110f3e0d4423b3f9088e92fc3dce4){width="153"}
:::
:::
:::
:::
...
-   If you need to create an excessive number of delegating methods,
    *server-class* risks becoming an unneeded go-between, leading to an
    excess of [Middle Man](/smells/middle-man).
...
[Remove Middle Man []{.fa .fa-arrow-right}](/remove-middle-man){.btn
...
[[]{.fa .fa-arrow-left} Inline Class](/inline-class){.btn .btn-default
rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/hide-delegate "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/hide-delegate "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/hide-delegate "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/hide-delegate "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/hide-delegate "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/hide-delegate "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/hide-delegate "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/hide-delegate "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/hide-delegate "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/hide-delegate "中文"){.dropdown-item
