---
description: "Problem: A class does almost nothing and isn't responsible
  for anything, and no additional responsibilities are planned for it.
...
::: ba-container
![Inline Class -
Before](/images/refactoring/diagrams/Inline%20Class%20-%20Before.png?id=717d80baaa902d09acbaa55fd0539638){width="509"}
:::
:::
...
::: ba-container
![Inline Class -
After](/images/refactoring/diagrams/Inline%20Class%20-%20After.png?id=7cb7db0fe2ab0d17f067d411f9e98f15){width="209"}
:::
:::
:::
:::
...
3.  Now test the program and make sure that no errors have been added.
    ...
    Method](/move-method) and [Move Field](/move-field) to completely
    transplant all functionality to the recipient class from the
    original one. Continue doing so until the original class is
    completely empty.
...
[Hide Delegate []{.fa .fa-arrow-right}](/hide-delegate){.btn
...
[[]{.fa .fa-arrow-left} Extract Class](/extract-class){.btn .btn-default
rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/inline-class "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/inline-class "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/inline-class "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/inline-class "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/inline-class "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/inline-class "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/inline-class "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/inline-class "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/inline-class "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/inline-class "中文"){.dropdown-item
