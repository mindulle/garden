---
description: "Problem: A utility class doesn't contain the method that
  you need and you can't add the method to the class. Solution: Add the
  method to a client class and pass an object of the utility class to it
  as an argument."
lang: en
theme-color: "#95f3fc"
...
-   The reasons for having the method of a utility class in a client
    ...
    methods. [Introduce Local Extension](/introduce-local-extension) can
    help with this.
...
.fa-arrow-right}](/introduce-local-extension){.btn .btn-primary
rel="next"}
:::
...
[[]{.fa .fa-arrow-left} Remove Middle Man](/remove-middle-man){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/introduce-foreign-method "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/introduce-foreign-method "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/introduce-foreign-method "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/introduce-foreign-method "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/introduce-foreign-method "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/introduce-foreign-method "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/introduce-foreign-method "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/introduce-foreign-method "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/introduce-foreign-method "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/introduce-foreign-method "中文"){.dropdown-item
