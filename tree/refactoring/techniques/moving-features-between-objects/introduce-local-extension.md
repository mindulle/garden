---
description: "Problem: A utility class doesn't contain some methods that
  you need. But you can't add these methods to the class. Solution:
...
Before](/images/refactoring/diagrams/Introduce%20Local%20Extension%20-%20Before.png?id=3ba103e769691215bed0a50e1de1b80f){width="209"}
:::
:::
...
::: ba-container
![Introduce Local Extension -
After](/images/refactoring/diagrams/Introduce%20Local%20Extension%20-%20After.png?id=44bc24e5c4b86e28a9dfc9c67c9e21d1){width="209"}
:::
:::
:::
:::
...
[Organizing Data []{.fa
.fa-arrow-right}](/refactoring/techniques/organizing-data){.btn
...
Method](/introduce-foreign-method){.btn .btn-default rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/introduce-local-extension "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/introduce-local-extension "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/introduce-local-extension "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/introduce-local-extension "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/introduce-local-extension "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/introduce-local-extension "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/introduce-local-extension "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/introduce-local-extension "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/introduce-local-extension "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/introduce-local-extension "中文"){.dropdown-item
