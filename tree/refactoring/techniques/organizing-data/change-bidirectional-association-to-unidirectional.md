---
description: "Problem: You have a bidirectional association between
  classes, but one of the classes doesn't use the other's features.
...
Before](/images/refactoring/diagrams/Change%20Bidirectional%20Association%20to%20Unidirectional%20-%20Before.png?id=9fc2b8d6c54255295d2ef62d9e015c0a){width="396"}
:::
:::
...
::: ba-container
![Change Bidirectional Association to Unidirectional -
After](/images/refactoring/diagrams/Change%20Bidirectional%20Association%20to%20Unidirectional%20-%20After.png?id=0340aa25a071d7529343ebe3dd469ffd){width="396"}
:::
:::
:::
:::
...
.fa-arrow-right}](/replace-magic-number-with-symbolic-constant){.btn
...
Bidirectional](/change-unidirectional-association-to-bidirectional){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/change-bidirectional-association-to-unidirectional "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/change-bidirectional-association-to-unidirectional "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/change-bidirectional-association-to-unidirectional "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/change-bidirectional-association-to-unidirectional "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/change-bidirectional-association-to-unidirectional "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/change-bidirectional-association-to-unidirectional "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/change-bidirectional-association-to-unidirectional "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/change-bidirectional-association-to-unidirectional "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/change-bidirectional-association-to-unidirectional "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/change-bidirectional-association-to-unidirectional "中文"){.dropdown-item
