...
Before](/images/refactoring/diagrams/Encapsulate%20Collection%20-%20Before.png?id=0c01860495c763043a13ce47086e49f1){width="227"}
:::
:::
...
::: ba-container
![Encapsulate Collection -
After](/images/refactoring/diagrams/Encapsulate%20Collection%20-%20After.png?id=e8f5624c8d63963421680121d49a43de){width="284"}
:::
:::
:::
:::
...
.fa-arrow-right}](/replace-type-code-with-class){.btn .btn-primary
rel="next"}
:::
...
[[]{.fa .fa-arrow-left} Encapsulate Field](/encapsulate-field){.btn
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/encapsulate-collection "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/encapsulate-collection "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/encapsulate-collection "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/encapsulate-collection "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/encapsulate-collection "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/encapsulate-collection "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/encapsulate-collection "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/encapsulate-collection "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/encapsulate-collection "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/encapsulate-collection "中文"){.dropdown-item
