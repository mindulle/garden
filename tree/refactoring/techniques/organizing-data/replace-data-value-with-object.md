---
description: "Problem: A class (or group of classes) contains a data
  field. The field has its own behavior and associated data. Solution:
...
Before](/images/refactoring/diagrams/Replace%20Data%20Value%20with%20Object%20-%20Before.png?id=f9ecd087d0e9e71ec8be6622ac36e573){width="190"}
:::
:::
...
::: ba-container
![Replace Data Value with Object -
After](/images/refactoring/diagrams/Replace%20Data%20Value%20with%20Object%20-%20After.png?id=26b91a5742429b46df4885713fea0a74){width="434"}
:::
:::
:::
:::
...
Class](/extract-class). What makes it different is the cause of the
refactoring.

In [Extract Class](/extract-class), we have a single class that's
...
Field](/self-encapsulate-field) in order to hide it in the original
class.
...
Value to Reference](/change-value-to-reference) on the field that
...
.fa-arrow-right}](/change-value-to-reference){.btn .btn-primary
rel="next"}
:::
...
Field](/self-encapsulate-field){.btn .btn-default rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/replace-data-value-with-object "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/replace-data-value-with-object "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/replace-data-value-with-object "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/replace-data-value-with-object "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/replace-data-value-with-object "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/replace-data-value-with-object "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/replace-data-value-with-object "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/replace-data-value-with-object "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/replace-data-value-with-object "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/replace-data-value-with-object "中文"){.dropdown-item
