---
description: "Problem: Since some methods return null instead of real
  objects, you have many checks for null in your code. Solution: Instead
  of null, return a null object that exhibits the default behavior."
lang: en
theme-color: "#95f3fc"
...
[Introduce Assertion []{.fa .fa-arrow-right}](/introduce-assertion){.btn
...
Polymorphism](/replace-conditional-with-polymorphism){.btn .btn-default
rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/introduce-null-object "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/introduce-null-object "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/introduce-null-object "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/introduce-null-object "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/introduce-null-object "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/introduce-null-object "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/introduce-null-object "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/introduce-null-object "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/introduce-null-object "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/introduce-null-object "中文"){.dropdown-item
