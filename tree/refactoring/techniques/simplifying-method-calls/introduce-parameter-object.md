---
description: "Problem: Your methods contain a repeating group of
  parameters. Solution: Replace these parameters with an object."
lang: en
theme-color: "#95f3fc"
...
Before](/images/refactoring/diagrams/Introduce%20Parameter%20Object%20-%20Before.png?id=023aa35781e4c8d16e0faf7172646d1e){width="359"}
:::
:::
...
::: ba-container
![Introduce Parameter Object -
After](/images/refactoring/diagrams/Introduce%20Parameter%20Object%20-%20After.png?id=b5ed29b5678759399a83c229b1837730){width="359"}
:::
:::
:::
:::
...
.fa-arrow-right}](/remove-setting-method){.btn .btn-primary rel="next"}
:::
...
Call](/replace-parameter-with-method-call){.btn .btn-default rel="prev"}
:::
:::
...
-    [English]{.caption .d-none .d-lg-inline-block}
    ...
    [English](https://refactoring.guru/introduce-parameter-object "English"){.dropdown-item
    .locale-link .active locale="en"}
    [Español](https://refactoring.guru/es/introduce-parameter-object "Español"){.dropdown-item
    .locale-link locale="es"}
    [Français](https://refactoring.guru/fr/introduce-parameter-object "Français"){.dropdown-item
    .locale-link locale="fr"}
    [日本語](https://refactoring.guru/ja/introduce-parameter-object "日本語"){.dropdown-item
    .locale-link locale="ja"}
    [한국어](https://refactoring.guru/ko/introduce-parameter-object "한국어"){.dropdown-item
    .locale-link locale="ko"}
    [Polski](https://refactoring.guru/pl/introduce-parameter-object "Polski"){.dropdown-item
    .locale-link locale="pl"} [Português
    Brasileiro](https://refactoring.guru/pt-br/introduce-parameter-object "Português Brasileiro"){.dropdown-item
    .locale-link locale="pt-br"}
    [Русский](https://refactoring.guru/ru/introduce-parameter-object "Русский"){.dropdown-item
    .locale-link locale="ru"}
    [Українська](https://refactoring.guru/uk/introduce-parameter-object "Українська"){.dropdown-item
    .locale-link locale="uk"}
    [中文](https://refactoringguru.cn/introduce-parameter-object "中文"){.dropdown-item
